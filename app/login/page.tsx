      ...
      <div className="relative w-full max-w-sm animate-fade-in">
        ...
        <div className="glass rounded-2xl p-6 space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white text-gray-900 font-medium hover:bg-gray-100 active:scale-[0.98] transition-all duration-150 disabled:opacity-60"
          >
            {loading ? (
              <LoaderIcon size={20} className="animate-spin text-gray-500" />
            ) : (
              <GoogleIcon />
            )}
